...
.imax-logo {
  width: 50px;
  height: 15px;
  background: url("https://png2.cleanpng.com/sh/b0b7bbe0aad2336bcd8fa63ee67de0c3/L0KzQYm3VcA6N6ZvfZH0aYP2gLBuTgBpd6V0fARqcHjsc37tifxuNaNqfd42NXHpQrLrhMk5P2o2e6g3NUK4RIqCUcAyPWM6UKc8NkW6RYa8U75xdpg=/kisspng-photographic-film-reel-5af2add98791c6.5254991015258536575553.png") no-repeat;
	...
	<div class="movie-card">
		<div class="" align="center">
			<div class="header-icon-container">
				<a href="#">
                    <img src="<?php echo  IMG_BASE_TMBD . "w220_and_h330_face" . $ticket->getFuncion()->getMovie()->getPoster_path();?>" alt="Card image">
				</a>
			</div>
		</div><!--movie-header-->
        <div class="movie-content">
			<div class="movie-content-header">
				<a href="#">
					<h3 class="movie-title"><?php echo $ticket->getFuncion()->getMovie()->getTitle();?></h3>
				</a>
			...
			<div class="movie-info">
				<div class="info-section">
					...
					<span><?php echo $ticket->getFuncion()->getDate(); ?>- <?php echo $ticket->getFuncion()->getHour(); ?></span>
				</div><!--date,time-->
				<div class="info-section">
					<label>Screen</label>
					<span><?php echo $ticket->getFuncion()->getRoom()->getNombre(); ?></span>
				</div><!--screen-->
				<div class="info-section">
					<label>Row</label>
					<span>F</span>
